 ...
 */
export function openEditor(name: string, url = "about:blank"): Window {
...
export async function openTextEditor(folderEntry: FolderEntry) {
    ...
    const wind = openEditor(folderEntry.name, "text-editor.html");
...
export async function openImageEditor(folderEntry: FolderEntry) {
    ...
    if (blob == null) return;
    const wind = openEditor(folderEntry.name);
